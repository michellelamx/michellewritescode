export const testimonials = [
  {
    id: '01',
    name: 'Rebecca Evanhoe',
    title: 'Conversation Design Strategist @ Slang.ai',
    quote: `Michelle is an incredible addition to any team. She's a great cross-functional collaborator and a focused problem solver with top-tier decision-making and prioritization skills.\n\nAs a senior member on a team, she builds process and momentum, and her rigor helps those around her create structure as well. Michelle is both analytical and creative, and she's a lovely teammate too!`,
  },
  {
    id: '02',
    name: 'Jeff Huckabay',
    title: 'Senior Software Engineer',
    quote: `Michelle transformed the way we built the (Splunk SVP) UI and was able to standardize our work streams taking all the guess work out for the rest of the devs which massively reduced the back and forth needed between engineering and design.`,
  },
  {
    id: '03',
    name: 'Zak Fisher',
    title: 'Engineering Manager',
    quote: `Michelle has a wide range of experience developing client-side applications for a multitude of companies. I've had the pleasure of working with her on several projects, including creative sites for ad agencies and data-rich apps in the private sector.\n\nShe always brings a great energy to the team, and can always be relied on to take on any task, no matter the complexity. The quality of her work is evident, and any company would be lucky to benefit from her skill.`,
  },
  {
    id: '04',
    name: 'Gabe Duncan',
